...
# 获取所有JSON文件
json_files = glob.glob('json/*_data.json')
            ...
            for data_type, predictions in data.get('data', {}).items():
                ...
                for pred in predictions:
                    ...
                    if pred_date and predict is not None:
                        ...
                        cursor.execute('''
                        INSERT OR REPLACE INTO prediction_data (infer_date, data_type, pred_date, predict)
                        VALUES (?, ?, ?, ?)
...
print("\n数据类型包括:")
print("- CCI3800outinfer (进口煤价)")
print("- CCI4500infer (国内煤价)")
print("- CCI4700outinfer (进口煤价)")
print("- CCI5000infer (国内煤价)")
print("- CCI5500infer (国内煤价)")
print("- CCI5500outinfer (进口煤价)")
print("- insideinfer (国内运费)")
print("- outsideinfer (国际运费)")
