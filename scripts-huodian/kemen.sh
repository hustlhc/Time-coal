...
python -u run.py \
  ...
  --csv_path ./testresult/kemen_2.csv \
...
python -u run.py \
  ...
  --do_finetune 0 \
  --root_path  ./dataset-huodian \
  --csv_path ./testresult/kemen_1.csv \
...
python -u run.py \
  ...
  --do_finetune 0 \
  --root_path  ./dataset-huodian \
  --csv_path ./testresult/kemen_3.csv \
...
python -u run.py \
  ...
  --do_finetune 0 \
  --root_path  ./dataset-huodian \
  --csv_path ./testresult/kemen_4.csv \
...
python -u run.py \
  ...
  --do_finetune 0 \
  --root_path  ./dataset-huodian \
  --csv_path ./testresult/kemen_5.csv \
...
python -u run.py \
  ...
  --do_finetune 0 \
  --root_path  ./dataset-huodian \
  --csv_path ./testresult/kemen_6.csv \
