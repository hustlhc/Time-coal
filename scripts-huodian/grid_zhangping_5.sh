...
# 创建日志文件名（包含时间戳）
log_file="grid_zhangping_5_$(date +%Y%m%d_%H%M%S).log"
        ...
        for d_model in "${d_models[@]}"; do
          for d_ff in "${d_ffs[@]}"; do
            for moving_avg in "${moving_avgs[@]}"; do
              ...
              # 生成唯一的模型ID
              model_id="zhangping_5_TimeMixer_${seq_len}_60_${counter}"
              ...
              python -u run.py \
                ...
                --csv_path "./testresult/zhangping/zhangping_5_${seq_len}.csv" \
