...
# 超参数循环设置（在这里修改即可）
# =============================
seq_len_list="32 64 96 120" # 32 64 96 120
e_layers=3
down_sampling_window_list='1 2' # 1 2
d_model=32
d_ff=32
batch_size=16
down_sampling_layers_list="1 3" # 1 3
moving_avg_list="5 15" # 5 15
decomp_method=("moving_avg")
if [ $# -gt 0 ]; then
  targets=($1)   # 传入时支持多个，如 "A B C"
else
  # 默认值（如果没传就用全部）
  targets=("CCI进口3800" "CCI进口4700" "CCI进口5500" "CCI4500" "CCI5000" "CCI5500")
fi
