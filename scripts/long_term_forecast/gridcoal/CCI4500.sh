        ...
        do
          ...
          do
              ...
              python -u run.py \
                  ...
                  --csv_path ./pre_coal/coal_CCI4500outnew_result_${seq_len}_${e_layers}_${d_ff}_${down_sampling_window}_${d_model}_${down_sampling_window}.csv \
                  --is_training 1 \
                  --root_path  ./dataset/pre_coal/\
                  --data_path coal_new.csv \
                  --model_id CCI4500new_TimeMixer_${seq_len}_60 \
                  --model $model_name \
                  --data coal \
                  --features MS \
                  --target_features 1 \
                  ...
                  2>&1 | tee -a gridCCI4500_search_results.log
              done
           done   
        done
      done
