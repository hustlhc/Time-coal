  ...
  do
    ...
    do
      ...
      python -u run.py \
        ...
        --csv_path ./TimesNet_inferresult/infer_4700/infer_result_4700_sl${seq_len}_pl${pred_len}_el${e_layers}_dl${d_layers}_dm${d_model}_df${d_ff}.csv \
        --data_path 4700_infer.csv \
