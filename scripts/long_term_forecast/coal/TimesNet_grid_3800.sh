...
model_name=TimesNet
log_dir=./TimesNet_logs/3800_new
result_dir=./TimesNet_results/coal_3800_new
mkdir -p $log_dir
mkdir -p $result_dir
  ...
  do
    ...
    do
      ...
      do
        ...
        do
          # 生成唯一的 CSV 文件名
          csv_filename="3800new_sl${seq_len}_ll${label_len}_dm${d_model}_df${d_ff}_el${e_layers}_dl${d_layers}.csv"
          csv_path="$result_dir/$csv_filename"
          
          log_file=$log_dir/3800new_sl${seq_len}_ll${label_len}_dm${d_model}_df${d_ff}_el${e_layers}_dl${d_layers}.log
          ...
          python -u run.py \
            ...
            --model_id TimesNet_3800_new_seq_len${seq_len}_${pred_len} \
            --model $model_name \
            --data coal \
            --features MS \
            --seq_len $seq_len \
